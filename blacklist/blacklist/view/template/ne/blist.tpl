...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-ban"></i> <?php echo $text_blisted_emails; ?></h3>
            </div>
            <div class="panel-body">
                ...
                <fieldset>
                    <legend><?php echo $text_blisted_emails; ?></legend>
                    <div class="well">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                    ...
                    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="mainform" class="form-horizontal">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php if ($blisted) { ?>
                                        <?php foreach ($blisted as $entry) { ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php if (in_array($entry['blist_id'], $selected)) { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $entry['blist_id']; ?>" checked="checked" />
                                                    <?php } else { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $entry['blist_id']; ?>" />
                                                    <?php } ?>
                                                </td>
    ...
    <script type="text/javascript"><!--
        $('#button-filter').on('click', function() {
            var url = 'index.php?route=ne/blist&token=<?php echo $token; ?>';
