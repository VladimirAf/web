...
class ModelNeBlist extends Model {

    public function getTotal($data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "ne_blist";
    ...
    public function getList($data = array()) {
        ...
        $sql = "SELECT * FROM " . DB_PREFIX . "ne_blist";
    ...
    public function add($data) {
        ...
        if ($emails) {
            ...
            foreach ($emails as $email) {
                ...
                $this->db->query("INSERT IGNORE INTO " . DB_PREFIX . "ne_blist SET email = '" . $this->db->escape($email) . "'");
    ...
    public function delete($blist_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "ne_blist WHERE blist_id = '" . (int)$blist_id . "'");
    }
